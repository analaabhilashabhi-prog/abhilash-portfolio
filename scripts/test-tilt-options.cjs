...
// 1. Current (baseline)
testQuad('1. Current baseline', [0.2403, 0.2078], [0.7685, 0.0690], [0.7525, 0.6650], [0.1982, 0.8054]);

// 2. Medium tilt (~11° tilt)
testQuad('2. Medium tilt (~11°)', [0.2380, 0.2220], [0.7720, 0.0450], [0.7540, 0.6380], [0.1950, 0.8160]);

// 3. Pronounced tilt (~13.5° tilt)
testQuad('3. Pronounced tilt (~13.5°)', [0.2350, 0.2380], [0.7750, 0.0280], [0.7560, 0.6180], [0.1920, 0.8280]);
